...
-- CreateEnum
CREATE TYPE "ContentBlockType" AS ENUM ('BANNER', 'FEATURED_COLLECTION', 'ANNOUNCEMENT');
...
CREATE TABLE "StoreSettings" (
    ...
    "heroContent" JSONB NOT NULL DEFAULT '{}',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "ContentBlock_active_position_idx" ON "ContentBlock"("active", "position");
